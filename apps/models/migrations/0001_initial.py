    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('full-stack', 'Full-Stack Programming'), ('front-end', 'Front-End Programming'), ('back-end', 'Back-End Programming'), ('other', 'Other')], max_length=50)),
                ('skills', models.TextField(blank=True, null=True)),
                ('is_worldwide', models.CharField(choices=[('y', 'Yes'), ('n', 'N')], default='y', max_length=1)),
